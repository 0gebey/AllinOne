...
const AuthForm = (props) => {
  ...
  return (
    ...
    <View style={styles.viewStyle}>
      ...
      <View>
      <Icon name={'person-circle-outline'} size={28} color={'rgba(255, 255, 255, 0.7)'} style={styles.inputIcon} />
      <TextInput
        style={styles.textInput}
      ...
      <View>
      <Icon name={'ios-man'} size={28} color={'rgba(255, 255, 255, 0.7)'} style={styles.inputIcon} />
      <TextInput
        style={styles.textInput}
