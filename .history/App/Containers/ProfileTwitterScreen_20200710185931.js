            ...
            <KeyboardAvoidingView>
              ...
              <View style= {styles.profileContainer}>
                ...
                <Avatar
                      ...
                      source={{
                        uri:
                          this.state.twitterProfile.profile_image_url
                      }}
                      showEditButton
                ...
                <View style={styles.listContainer} >
                  ...
                  <View style={styles.listStyle}>
                    <Text style={styles.listText}>Favorites: {this.state.twitterProfile.favourites_count} {"\n"}
                    </Text>
                    <Text style={styles.listText}>Created At: {this.state.twitterProfile.created_at} {"\n"}
                    </Text>
