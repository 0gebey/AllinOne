            ...
            <ScrollView style={styles.mainContainer}>
              ...
              <KeyboardAvoidingView>
                ...
                <View style={styles.viewStyle}>
                  ...
                  <Text style = {styles.ApiText}>Please select an App that you want to make search</Text>
                  <Picker
                  ...
                  < TouchableOpacity onPress={() => this.onSearchButtonPressed()} style={styles.loginButton}>
                    <Text style={styles.loginButtonText}>
                      SEARCH
             </Text>
                  </TouchableOpacity>
                  < TouchableOpacity onPress={() => this.onCreatehButtonPressed() } style={styles.loginButton}>
                    <Text style={styles.loginButtonText}>
                      CREATE A PROFILE
             </Text>
                  </TouchableOpacity>
                  <TouchableOpacity onPress={() => signout(this.onSignedOut)} style={styles.loginButton}>
                    <Text style={styles.loginButtonText}>
                      SIGN OUT
             </Text>
                  </TouchableOpacity>
