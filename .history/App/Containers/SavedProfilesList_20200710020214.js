  ...
  onPressDetailButton(userKey) {
    ...
    query.once('value', function (snapshot) {
      snapshot.forEach(function (message) {
        console.log(message.key + ': ' + message.val().githubUserName)
        this.setState({
          userName: message.val().githubUserName,
          userTwitterName: message.val().twitterUserName,
        });
      });
    });
    console.log(this.state.userName);
    console.log(this.state.twitterUserName);
