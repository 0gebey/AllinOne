              ...
              <KeyboardAvoidingView >
                ...
                />
                 ...
                 <Text style= {styles.createProfileText}>Create a Profile</Text>
                  ...
                  <Text style= {{paddingTop: 10, fontSize: 16, color: '#fff'}}>User Name(Nickname):</Text>
                  <TextInput style= {styles.textInput} onChangeText={text => this.setState({nickname: text})}></TextInput>
                  </View>
                  <View style={{flex:1, alignItem: 'center' , justifyContent: 'space-between' , padding:5 ,flexDirection: 'row', width: '100%'}}>
                  <Text style= {{paddingTop: 10, fontSize: 16, color: '#fff', paddingRight: 22}}>User Name(Twitter):</Text>
                  <TextInput style= {styles.textInput} onChangeText={text => this.setState({twitterUserName : text})}></TextInput>
                  </View>
                  <View style={{flex:1, alignItem: 'center' , justifyContent: 'space-between' , padding:5 ,flexDirection: 'row', width: '100%'}}>
                  <Text style= {{paddingTop: 10, fontSize: 16, color: '#fff', paddingRight: 22}}>User Name(GitHub):</Text>
                  <TextInput style= {styles.textInput} onChangeText={text => this.setState({githubUserName : text})}></TextInput>
                  </View>
                </KeyboardAvoidingView>
              </ScrollView>
            </SafeAreaView>
