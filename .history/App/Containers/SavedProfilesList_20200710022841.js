  ...
  onPressDetailButton(userKey) {
    ...
    query.once('value', function (snapshot) {
      snapshot.forEach(function (profile) {
        ...
        var userName = profile.val().githubUserName;
        console.log(userName)
        // this.setState({userName: profile.val().githubUserName.toString()})
        // let userName = profile.val().githubUserName;
        // let userTwitterName = profile.val().twitterUserName;
        // this.props.userRequest(userName);
        //    console.log(userName)
      });
    });
    ...
    // this.props.navigation.navigate('DetailedInformation', {userKey: userKey});
  }
