...
class SavedScreen extends Component {
  ...
  saveProfile = () => {
    ...
    var newKey = ref(`/users/${currentUser.uid}`).push().key();
            ...
            <KeyboardAvoidingView>
              ...
              <View
                ...
                <TextInput
                  ...
                  placeholder="User Nick Name" placeholderTextColor={'rgba(255, 255, 255, 0.5)'}></TextInput>
              </View>
              <View
                style={{
                  flex: 1,
                ...
                <TextInput
                  ...
                  placeholder="User Twitter Name" placeholderTextColor={'rgba(255, 255, 255, 0.5)'}></TextInput>
              </View>
              <View
                style={{
                  flex: 1,
                ...
                <TextInput
                  ...
                  placeholder="User GitHub Name" placeholderTextColor={'rgba(255, 255, 255, 0.5)'}></TextInput>
              </View>
