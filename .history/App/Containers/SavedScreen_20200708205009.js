...
import { ScrollView, Text, KeyboardAvoidingView, Image, TouchableOpacity, ImageBackground, FlatList } from 'react-native'
            ...
            <SafeAreaView style={styles.scrollContainer}>
              <ScrollView style={styles.mainContainer}>
                ...
                <KeyboardAvoidingView>
                  <View style={{flex:1, alignItem: 'center' , justifyContent: 'space-between' , padding:5}}>
                  <Text>User Name(Nickname)</Text>
