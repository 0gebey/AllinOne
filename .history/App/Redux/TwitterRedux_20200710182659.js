...
export const request = (state) => {
  return {...state,isTwitterNameTrue: false,twitterFailed: false, twitterProfile: null, payload}
}
// successful api lookup
export const success = (state,{twitterProfile} ) => {
 
  return {...state,isTwitterNameTrue: true,twitterFailed: false, twitterProfile , payload: { twitterProfile }}
}
