...
const { Types, Creators } = createActions({
  ...
  userFailure: null,
  twitterRequest1: ['screen_name'],
  twitterSuccess1: ['twitterProfile'],
  twitterFailure1: null,
...
export const reducer = createReducer(INITIAL_STATE, {
  ...
  [Types.TWITTER_REQUEST1]: request1,
  [Types.USER_SUCCESS]: success,
  [Types.TWITTER_SUCCESS1]: success1,
  [Types.USER_FAILURE]: failure,
  [Types.TWITTER_FAILURE1]: failure1
})
